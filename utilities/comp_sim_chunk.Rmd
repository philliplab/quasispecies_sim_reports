...
A systematic investigation of the variation of the average pairwise hamming distances by the within/between ratio. Note this plot only works if there are > 100 simulations for each category.
...
ggplot(tmp_dat, aes(x = avg_hd, y = avg_ratio_cat)) +
