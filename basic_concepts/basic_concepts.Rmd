...
for (i in 1:10){
  ...
  x$sim_n <- i
  x <- x %>% select(sim_n, original_cols)
...
This needs another new and more complex datastructure. It needs to track the different groupings of the the simulations. Design this next.
