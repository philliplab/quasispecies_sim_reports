...
Three data structures are used to track all this:

- the all_sim_results data.frame - see the few_sim_chunk
- the group_membership data.frame: sim_id, group_n, group_label and group description
- arg_sets: A list indexed by group_id and each element is a argument set for sim_pop.
