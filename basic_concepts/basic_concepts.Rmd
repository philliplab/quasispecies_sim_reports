...
A first simulation to demonstrate the process and the measuring tools. The following table shows the configuration that was used to call `sim_pop` from the `yasss` package. A high level summary of the entire genealogy is provided in the second table.
